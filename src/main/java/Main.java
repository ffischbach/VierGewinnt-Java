...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(namePlayer1 + " Please set your Token (should include just 1 number or letter) :");
        ...
        System.out.println(namePlayer2 + " Please set your Token (should include just 1 number or letter):");
